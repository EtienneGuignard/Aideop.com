...
class Role extends \App\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Role' . "\0" . 'users'];
        }
     ...
     * {@inheritDoc}
     */
    public function addUser(\App\Entity\User $user): \App\Entity\Role
    {
     ...
     * {@inheritDoc}
     */
    public function removeUser(\App\Entity\User $user): \App\Entity\Role
    {
