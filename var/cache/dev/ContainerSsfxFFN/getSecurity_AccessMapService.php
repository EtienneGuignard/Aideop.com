...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/surgeon'), [0 => 'ROLE_SURGEON'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/nurse'), [0 => 'ROLE_NURSE'], NULL);
