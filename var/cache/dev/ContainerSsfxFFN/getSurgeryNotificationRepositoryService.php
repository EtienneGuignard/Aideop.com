 ...
 */
class getSurgeryNotificationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SurgeryNotificationRepository' shared autowired service.
     *
     * @return \App\Repository\SurgeryNotificationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SurgeryNotificationRepository.php';

        return $container->privates['App\\Repository\\SurgeryNotificationRepository'] = new \App\Repository\SurgeryNotificationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
