 ...
 */
class getCpsCardOwnerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CpsCardOwnerRepository' shared autowired service.
     *
     * @return \App\Repository\CpsCardOwnerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CpsCardOwnerRepository.php';

        return $container->privates['App\\Repository\\CpsCardOwnerRepository'] = new \App\Repository\CpsCardOwnerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
