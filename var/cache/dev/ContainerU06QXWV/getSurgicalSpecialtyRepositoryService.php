 ...
 */
class getSurgicalSpecialtyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SurgicalSpecialtyRepository' shared autowired service.
     *
     * @return \App\Repository\SurgicalSpecialtyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SurgicalSpecialtyRepository.php';

        return $container->privates['App\\Repository\\SurgicalSpecialtyRepository'] = new \App\Repository\SurgicalSpecialtyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
