 ...
 */
class getClinicRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClinicRepository' shared autowired service.
     *
     * @return \App\Repository\ClinicRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClinicRepository.php';

        return $container->privates['App\\Repository\\ClinicRepository'] = new \App\Repository\ClinicRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
